...
function Pekerja(props) {
    ...
    const setUpload = async (files, id, url_foto)=>{
        ...
        await fetch("https://api.dinarcahayanegara.com" + `/upload/${id}`, options).then(function(res) {
            alert("Tes");
            console.log(res);
        // if (res.ok) {
        //   alert("Perfect! ");
                                                    ...
                                                    children: data.map((item, itemIndex)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)(StyledTableRow, {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ jsx_runtime_.jsx(StyledTableCell, {
                                                                    ...
                                                                    children: /*#__PURE__*/ jsx_runtime_.jsx(material_.Avatar, {
                                                                        alt: "Remy Sharp",
                                                                        src: "https://api.dinarcahayanegara.com" + `/${item.url_foto}`
                                                                    })
                                                                }),
                                                                /*#__PURE__*/ jsx_runtime_.jsx(StyledTableCell, {
                                                                    component: "th",
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ jsx_runtime_.jsx(material_.Button, {
                                                                            ...
                                                                            onClick: ()=>{
                                                                                ...
                                                                                setUrlfoto("https://api.dinarcahayanegara.com" + `/${item.url_foto}`);
                                                                            },
...
async function getServerSideProps(context) {
    var urlEmployers = "https://api.dinarcahayanegara.com" + "/pekerja";
    var resEmployers = await fetch(urlEmployers, {
        method: "GET"
    });
    const employerList = await resEmployers.json();
    var urlDatareferensiLokasiPekerja = "https://api.dinarcahayanegara.com" + "/lokasikerja";
